...
> 컴포넌트는 현재의 상황에 맞춰서 효율적으로 개발하는 것이 중요합니다. 특히 확정되지 않은 기획 문서를 예측하여 기능을 개발하는 경우 프로젝트의 복잡성과 요구사항이 변경되면 오히려 개발을 더 어렵게 만드는 요인이 됩니다. 이는 어디까지나 예제로서 작성합니다. 소프트웨어 개발 원칙 참고: [YAGNI](https://ko.wikipedia.org/wiki/YAGNI)
...
- [Thinking in React](https://ko.legacy.reactjs.org/docs/thinking-in-react.html)
- [리액트 공식 문서](https://ko.react.dev/learn/thinking-in-react)
